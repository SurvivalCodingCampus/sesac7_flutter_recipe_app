...
class MockBookMarkRepositoryImpl implements BookmarkRepository {
  ...
  final Map<String, dynamic> bookmarkRecipeJson = {
    "recipes": [
      {
        "category": "Indian",
        "id": 1,
  ...
  @override
  Future<Result<List<Recipe>, String>> getBookmarkRecipes() async {
    final Recipes recipes = RecipesDto.fromJson(bookmarkRecipeJson).toModel();
