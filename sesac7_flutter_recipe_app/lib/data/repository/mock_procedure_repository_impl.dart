...
class MockProcedureRepositoryImpl implements ProcedureRepository {
  final Map<String, dynamic> procedureJson = {
    'procedures': [
      {
        'recipeId': 1,
        'step': 1,
  ...
  @override
  Future<Result<List<Procedure>, NetworkError>> getProcedures(
    int recipeId,
  ) async {
    final List<Procedure> mockProcedures = ProceduresDto.fromJson(
      procedureJson,
    ).toModel().procedures;
    return Success(mockProcedures);
  }
}
