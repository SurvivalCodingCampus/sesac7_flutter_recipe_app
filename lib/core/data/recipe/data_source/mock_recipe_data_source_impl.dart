import 'package:flutter_recipe_app/core/data/recipe/data_source/recipe_data_source.dart';
import 'package:flutter_recipe_app/core/data/recipe/dto/recipe_dto.dart';
...
class MockRecipeDataSourceImpl implements RecipeDataSource {
  ...
  Future<List<RecipeDto>> getAllRecipes() async {
    return (data['recipes'] as List).map((e) => RecipeDto.fromJson(e)).toList();
  }
}
